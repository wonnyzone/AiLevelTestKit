//
//  ALLTSelectableCollectionViewCell.swift
//  AILevelTest
//
...
class ALLTSelectableCollectionViewCell: UICollectionViewCell {
    class var sectionInsets: UIEdgeInsets {
        return UIEdgeInsets(top: 0, left: 16, bottom: 0, right: 16).optimized
    }
    ...
    class func itemSize(with string: String) -> CGSize {
        ...
        label.sizeToFit()
        itemSize.width = label.bounds.size.width + 48.optimized
        
        itemSize.height = 52.optimized
