//
//  ALTJuniorMicTestViewController.swift
//  AILevelTest
//
...
class ALTJuniorMicTestViewController: ALTBaseViewController {
...
//            self.view.layoutIfNeeded()
    ...
    override func viewDidLoad() {
        ...
        label.font = UIFont.systemFont(ofSize: 18.optimized, weight: .semibold)
        label.numberOfLines = 0
        self.view.addSubview(label)
        
        label.centerYAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant:  -ALTJuniorTestNavigationController.additionalSafeAreaInsets.top / 2).isActive = true
        label.centerXAnchor.constraint(equalTo: self.view.centerXAnchor).isActive = true
        label.widthAnchor.constraint(equalToConstant: 200.optimized).isActive = true
        ...
        _labelGuide.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: -(UIApplication.shared.keyWindow?.safeAreaInsets.top ?? 0)).isActive = true
        ...
        _buttonRecordSingle.topAnchor.constraint(equalTo: _viewRecord.bottomAnchor, constant: 50.optimizedWithHeight).isActive = true
...
extension ALTJuniorMicTestViewController: ALTSpeechToTextManagerDelegate {
