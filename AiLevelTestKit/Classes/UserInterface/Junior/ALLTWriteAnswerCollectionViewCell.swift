//
//  ALLTWriteAnswerCollectionViewCell.swift
//  AILevelTest
//
...
class ALLTWriteAnswerCollectionViewCell: UICollectionViewCell {
    class var sectionInsets: UIEdgeInsets {
        return UIEdgeInsets(top: 0, left: 32, bottom: 0, right: 32).optimized
    }
    ...
    class func itemSize(with string: String? = nil) -> CGSize {
        ...
        if string != nil {
            ...
            let sectionInsets = ALLTWriteAnswerCollectionViewCell.sectionInsets
            let interItemSpacing = ALLTWriteAnswerCollectionViewCell.interItemSpacing
            itemSize.width = ((UIScreen.main.bounds.size.width - sectionInsets.left - sectionInsets.right - (interItemSpacing * 4)) / 5).rounded(.down)
        }
    ...
    override init(frame: CGRect) {
        ...
        _labelTitle.font = UIFont.systemFont(ofSize: 20.optimized, weight: .bold)
